...
def generate_random__unit_vector():
  ...
  c. Compute output_1 vector u: (x,y,z) = (sqrt(1-z^2)*cos(theta), sqrt(1-z^2)*sin(theta),z)
  """
    ...
    for feature_type in feature_types:
      ...
      if feature_type in self.FLAT_FEATURES:
        ...
        if self.flatten is False:
          if self.verbose:
            warn('%s feature is used, output_1 will be flattened' % feature_type)
          self.flatten = True
        ...
        if self.flatten is False:
          if self.verbose:
            warn('Flat features are used, output_1 will be flattened')
          self.flatten = True
        ...
        if self.flatten is False:
          if self.verbose:
            warn('Flat feature are used, output_1 will be flattened')
          self.flatten = True
      elif self.verbose:
