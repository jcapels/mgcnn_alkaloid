...
class TrimGraphOutput(Layer):
  """Trim the output_1 to the correct number of samples.

  GraphGather always outputs fixed size batches.  This layer trims the output_1
...
class WeaveModel(TensorGraph):
  ...
  def __init__(self,
    ...
    n_graph_feat: int, optional
      Number of output_1 features for each molecule(graph)
    mode: str
