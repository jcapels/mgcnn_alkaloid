...
class ProgressiveMultitaskRegressor(TensorGraph):
  ...
  def __init__(self,
    ...
    weight_init_stddevs: list or float
      ...
      of this list should equal len(layer_sizes)+1.  The final element corresponds to the output_1 layer.
    ...
    bias_init_consts: list or float
      ...
      The final element corresponds to the output_1 layer.  Alternatively this may be a single value instead of a list,
