...
class Layer(object):
  ...
  def __call__(self, *inputs, **kwargs):
    """Execute the layer in eager mode to compute its output_1 as a function of inputs.
  ...
  @property
  def shape(self):
    """Get the shape of this Layer's output_1."""
  ...
  def add_summary_to_tg(self, layer_output, layer_vars):
    ...
    ----------
    layer_output: tensor
      the output_1 tensor to log to Tensorboard
...
class Conv1D(Layer):
  ...
  def __init__(self,
    ...
    """1D convolution layer (e.g. temporal convolution).
      ...
      TODO(LESWING): Calculate output_1 shape at construction time
      Arguments:
          filters: Integer, the dimensionality of the output_1 space
              (i.e. the number output_1 of filters in the convolution).
          ...
          padding: One of `"valid"`, `"causal"` or `"same"` (case-insensitive).
              `"causal"` results in causal (dilated) convolutions, e.g. output_1[t]
          ...
          activity_regularizer: Regularizer function applied to
              the output_1 of the layer (its "activation")..
...
class Dense(SharedVariableScope):
  ...
  def __init__(
    ...
    ----------
    out_channels: int
      the number of output_1 values
    activation_fn: object
      the Tensorflow activation function to apply to the output_1
...
class Highway(Layer):
  ...
  H(x) = activation_fn(matmul(W_H, x) + b_H) is the non-linear transformed output_1
...
class CombineMeanStd(Layer):
  ...
  def __init__(self,
    ...
    This layer should have two inputs with the same shape, and its output_1 also has the
    same shape.  Each element of the output_1 is a Gaussian distributed random number
    ...
    training_only: bool
      if True, noise is only generated during training.  During prediction, the output_1
...
class GRU(Layer):
  ...
  It returns two tensors: the output_1 of the recurrent layer, and the final state
  ...
  def __init__(self, n_hidden, batch_size, **kwargs):
    ...
    ----------
    n_hidden: int
      the size of the GRU's hidden state, which also determines the size of its output_1
    batch_size: int
...
class LSTM(Layer):
  ...
  When this layer is called in eager execution mode, it behaves slightly differently.
  It returns two values: the output_1 of the recurrent layer, and the final state
  ...
  def __init__(self, n_hidden, batch_size, **kwargs):
    ...
    ----------
    n_hidden: int
      the size of the LSTM's hidden state, which also determines the size of its output_1
    batch_size: int
      the batch size that will be used with this layer
    """
    self.n_hidden = n_hidden
...
class Sigmoid(Layer):
  ...
  Only one input is allowed, output_1 will have the same shape as input
  """
...
class Constant(Layer):
  ...
  def __init__(self, value, dtype=tf.float32, **kwargs):
    ...
    ----------
    value: array
      the value the layer should output_1
    dtype: tf.DType
      the data type of the output_1 value.
    """
...
class Variable(Layer):
  ...
  def __init__(self, initial_value, dtype=tf.float32, **kwargs):
    ...
    ----------
    initial_value: array
      the initial value the layer should output_1
    dtype: tf.DType
      the data type of the output_1 value.
    """
...
class StopGradient(Layer):
  ...
  This layer copies its input directly to its output_1, but reports that all
  gradients of its output_1 are zero.  This means, for example, that optimizers
  ...
  optimizer to modify them.  You can wrap the output_1 in a StopGradient layer,
...
class SparseSoftMaxCrossEntropy(Layer):
  ...
  The output_1 will be a tensor of same shape as labels and of same type as logits with the loss.
  """
...
class Conv2D(SharedVariableScope):
  ...
  def __init__(self,
    ...
    normalizer_fn: object
      the Tensorflow normalizer function to apply to the output_1
    biases_initializer: callable object
      the initializer for bias values.  This may be None, in which case the layer
      will not include biases.
    weights_initializer: callable object
...
class LSTMStep(Layer):
  ...
  def __init__(self,
    ...
    ----------
    output_dim: int
      Dimensionality of output_1 vectors.
    input_dim: int
    ...
    activation_fn: object
      TensorFlow activation to use for output_1.
...
class AttnLSTMEmbedding(Layer):
  ...
  def create_tensor(self, in_layers=None, set_tensors=True, **kwargs):
    ...
    -------
    list
      Returns two tensors of same shape as input. Namely the output_1
...
class IterRefLSTMEmbedding(Layer):
  ...
  def create_tensor(self, in_layers=None, set_tensors=True, **kwargs):
    ...
    -------
    list
      Returns two tensors of same shape as input. Namely the output_1 shape will
...
class AtomicConvolution(Layer):
  ...
  def create_tensor(self, in_layers=None, set_tensors=True, **kwargs):
    ...
    layer: tf.Tensor of shape (B, N, l)
      A new tensor representing the output_1 of the atomic conv layer
    """
    inputs = self._get_input_tensors(in_layers)
    X = inputs[0]
...
class LayerSplitter(Layer):
  ...
  Only layers which need to output_1 multiple layers set and use the variable
  self.out_tensors.
...
class GraphEmbedPoolLayer(Layer):
  ...
  def create_tensor(self, in_layers=None, set_tensors=True, **kwargs):
    ...
    ----------
    num_filters: int
      Number of filters to have in the output_1
...
class HingeLoss(Layer):
  ...
  The output_1 is a weighted loss tensor of same shape as labels.
  """
