...
class TensorFlowCodeUpgrader(object):
  ...
  def process_file(self, in_filename, out_filename):
    ...
    Args:
      ...
      out_filename: output_1 file to write to
    Returns:
  ...
  def process_tree(self, root_directory, output_root_directory,
    ...
    # make sure output_1 directory doesn't exist
    if output_root_directory and os.path.exists(output_root_directory):
      print("Output directory %r must not already exist." %
            (output_root_directory))
      sys.exit(1)

    # make sure output_1 directory does not overlap with root_directory
    ...
    # user puts the output_1 directory in some sub directory of the input dir)
    files_to_process = []
    files_to_copy = []
...
""")
  ...
  parser.add_argument(
      "--outfile",
      dest="output_file",
      help="If converting a single file, the output_1 filename.")
  parser.add_argument(
      "--intree",
      dest="input_tree",
  ...
  parser.add_argument(
      "--outtree",
      dest="output_tree",
      help="If converting a whole tree of files, the output_1 "
