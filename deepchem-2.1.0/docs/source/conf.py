...
# output_1. They are ignored by default.
# show_authors = False
...
# If true, `todo` and `todoList` produce output_1, else they produce nothing.
todo_include_todos = False

# -- Options for HTML output_1 ----------------------------------------------
...
# If true, an OpenSearch description file will be output_1, and all pages will
...
# -- Options for manual page output_1 ---------------------------------------
