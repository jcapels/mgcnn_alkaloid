...
class GraphConvolution(nn.Module):
    ...
    def __init__(self, n_conv_layers=1,
        ...
        n_atom_types: int, number of features describing each atom in 
            input 
        conv_layer_dims: list of ints, output_1 n_features for each
            graph conv layer 
        n_fc_layers: int, number of fully connected layers
        fc_layer_dims: list of ints, output_1 n_features for each
            fully connected layer 
        dropout: float, probability of zeroing out a given output_1 neuron
