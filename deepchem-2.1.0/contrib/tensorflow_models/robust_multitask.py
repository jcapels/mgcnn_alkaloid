...
class RobustMultitaskClassifier(MultiTaskClassifier):
  ...
  to task output_1. Hopefully will allow tasks to route around bad
  multitasking.
  """
  ...
  def __init__(self,
    ...
    prev_layer = mol_features
      ...
      for task in range(self.n_tasks):
        ...
        print("Adding output_1 weights of shape %s" % str([task_layer_size, 1]))
        output.append(
            model_ops.logits(
                task_layer,
                num_classes=2,
...
class RobustMultitaskRegressor(TensorflowMultiTaskRegressor):
  ...
  output_1. Hopefully will allow tasks to route around bad multitasking.
  """
