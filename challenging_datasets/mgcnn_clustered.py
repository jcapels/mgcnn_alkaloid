...
field_smiles = 'smiles'
path_alkaloid_data = 'training_set_clustered.csv'
...
dataset_test = dc_loader.featurize("clustered_test_set.csv")
...
df_results.to_csv('results_clustered.csv', index=False)